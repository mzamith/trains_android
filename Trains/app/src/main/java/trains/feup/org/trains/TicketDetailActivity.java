...
import trains.feup.org.trains.exception.ApiException;
...
public class TicketDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteDatabase db = ticketsDbHelper.getReadableDatabase();
        Cursor cursor;
        ...
        boolean isOkay = cursor.moveToNext();


        if (!isOkay) {
            Log.i("Ticket", "SHITS ABOUT TO HIT THE FAN!!!!!");
            Toast t = Toast.makeText(getContext(), "This Ticket was not bought using this device, please use the correct device", Toast.LENGTH_LONG);
            t.show();
            finish();
            Intent intent = new Intent(TicketDetailActivity.this, WalletActivity.class);
            ...
            Log.i("SQLITE READING", "GOT READABLE DATABASE: departure = " + departure + "; destination = " + destination + "; date = " + date + "; price = " + price + "; qrcontent = " + qrContent + ";");
